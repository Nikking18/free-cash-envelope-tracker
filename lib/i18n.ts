...
export const TRANSLATIONS: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    sumCashAdded: 'Deposits into envelopes',
    ...
    addExpenseBtn: 'ADD EXPENSE / CASH',
    ...
    logExpenseTitle: 'Log Expense or Add Cash',
    editExpenseTitle: 'Edit Transaction Log',
    selectEnvelopeLabel: 'Select Envelope',
    expenseAmountLabel: 'Amount / Price',
    expenseCurrencyLabel: 'Currency',
    vendorNoteLabel: 'Vendor / Note (Optional)',
    vendorNotePlaceholder: 'e.g. Walmart, Salary Deposit, Loan Repayment',
    expenseDateLabel: 'Transaction Date',
    transactionTypeLabel: 'Transaction Type',
    transactionTypeExpense: '💸 Expense (Deduct from Envelope)',
    transactionTypeAddCash: '💵 Add Cash (Deposit / Fund Envelope)',
    ...
    pdfDocTitle: 'CASH ENVELOPE BUDGET STATEMENT',
    pdfDocSubtitle: 'Report',
    pdfDateLabel: 'Generated on',
    pdfDateHeader: 'DATE',
    pdfPeriodLabel: 'Budget Period',
    pdfAllocatedCard: 'TOTAL ALLOCATED',
    pdfSpentCard: 'TOTAL SPENT',
    pdfCashAddedCard: 'TOTAL CASH ADDED',
    pdfRemainingCard: 'TOTAL REMAINING',
    pdfEnvelopesSection: 'ENVELOPE BREAKDOWN',
    pdfEnvNameHeader: 'ENVELOPE NAME',
    pdfCategoryHeader: 'CATEGORY',
    pdfAllocatedHeader: 'ALLOCATED',
    pdfSpentHeader: 'SPENT',
    pdfCashAddedHeader: 'CASH ADDED',
    pdfRemainingHeader: 'AVAILABLE BALANCE',
    pdfEnvelopeLedgers: 'ENVELOPE LEDGERS',
    pdfEnvelopeLedgersSubtitle: 'Individual envelope tracking boxes with chronological transactions and running balance.',
    pdfTxSection: 'TRANSACTION HISTORY',
    pdfDescHeader: 'NOTE / VENDOR',
    pdfAmountHeader: 'AMOUNT',
    pdfTypeHeader: 'TYPE',
    pdfRunningBalanceHeader: 'RUNNING BALANCE',
    pdfTypeExpense: 'EXPENSE',
    pdfTypeAddCash: 'CASH IN',
    pdfCategoryEnvelopeHeader: 'CATEGORY / ENVELOPE',
    pdfTotalBalanceHeader: 'TOTAL BALANCE',
    pdfNotesSection: 'NOTES & BUDGET REMINDERS',
    pdfHandwritingText: 'Print this page to write your own notes and reminders by hand.',
  ...
  es: {
    ...
    exchangeRateAccuracyNotice: 'Aviso: Las tasas de cambio en vivo se proporcionan solo como referencia y pueden no ser 100% exactas o en tiempo real. Verifique las tasas independientemente.',
    ...
    logExpense: 'REGISTRAR GASTO / EFECTIVO',
    import: 'Importar',
    export: 'Exportar',
    ...
    totalCashAdded: 'Efectivo Añadido',
    totalSpent: 'Total Gastado',
    totalRemaining: 'Total Restante',
    labelAvailable: 'Disponible',
    labelSpent: 'Gastado',
    labelCashAdded: 'Efectivo Añadido',
    sumAllocated: 'Suma de objetivos',
    sumCashAdded: 'Depósitos en sobres',
    sumSpent: 'Suma de gastos',
    ...
    addExpenseBtn: 'AÑADIR GASTO / EFECTIVO',
    ...
    notesRemindersDesc: 'Añade cualquier nota de presupuesto personalizada, objetivos para el día de pago o instrucciones. Las notas ingresadas aparecerán directamente en tu PDF exportado. Si se deja en blanco, tu PDF incluirá líneas en blanco con instrucciones para escribir notas a mano.',
    notesRemindersPlaceholder: 'ej. Pagar alquiler el día 1. Transferir $200 a ahorro de emergencia en el día de pago.',
    ...
    logExpenseTitle: 'Registrar Gasto o Añadir Efectivo',
    editExpenseTitle: 'Editar Registro de Transacción',
    selectEnvelopeLabel: 'Seleccionar Sobre',
    expenseAmountLabel: 'Monto / Precio',
    expenseCurrencyLabel: 'Moneda',
    vendorNoteLabel: 'Proveedor / Nota (Opcional)',
    vendorNotePlaceholder: 'ej. Supermercado, Depósito de Salario, Reembolso',
    expenseDateLabel: 'Fecha de Transacción',
    transactionTypeLabel: 'Tipo de Transacción',
    transactionTypeExpense: '💸 Gasto (Deducir del sobre)',
    transactionTypeAddCash: '💵 Añadir Efectivo (Depositar en sobre)',
    ...
    pdfDocTitle: 'ESTADO DE PRESUPUESTO DE SOBRES',
    pdfDocSubtitle: 'Informe',
    pdfDateLabel: 'Generado el',
    pdfDateHeader: 'FECHA',
    pdfPeriodLabel: 'Período del Presupuesto',
    pdfAllocatedCard: 'TOTAL ASIGNADO',
    pdfSpentCard: 'TOTAL GASTADO',
    pdfCashAddedCard: 'TOTAL EFECTIVO AÑADIDO',
    pdfRemainingCard: 'TOTAL RESTANTE',
    ...
    pdfCashAddedHeader: 'EFECTIVO AÑADIDO',
    pdfRemainingHeader: 'SALDO DISPONIBLE',
    pdfEnvelopeLedgers: 'LIBROS DE SOBRES',
    pdfEnvelopeLedgersSubtitle: 'Registro cronológico por sobre con saldo acumulado.',
    pdfTxSection: 'HISTORIAL DE TRANSACCIONES',
    pdfDescHeader: 'NOTA / PROVEEDOR',
    pdfAmountHeader: 'MONTO',
    pdfTypeHeader: 'TIPO',
    pdfRunningBalanceHeader: 'SALDO ACUMULADO',
    pdfTypeExpense: 'GASTO',
    pdfTypeAddCash: 'INGRESO',
    pdfCategoryEnvelopeHeader: 'CATEGORÍA / SOBRE',
    pdfTotalBalanceHeader: 'SALDO TOTAL',
    pdfNotesSection: 'NOTAS Y RECORDATORIOS',
    pdfHandwritingText: 'Imprime esta página para escribir tus propias notas y recordatorios a mano.',
  ...
  fr: {
    ...
    exchangeRateAccuracyNotice: 'Avertissement : Les taux de change en direct sont fournis à titre indicatif et peuvent ne pas être 100 % précis ou en temps réel. Veuillez vérifier les taux de manière indépendante.',
    ...
    logExpense: 'ENREGISTRER DÉPENSE / ARGENT',
    import: 'Importer',
    export: 'Exporter',
    ...
    totalCashAdded: 'Argent Ajouté',
    totalSpent: 'Total Dépensé',
    totalRemaining: 'Total Restant',
    labelAvailable: 'Disponible',
    labelSpent: 'Dépensé',
    labelCashAdded: 'Argent Ajouté',
    sumAllocated: 'Somme des objectifs',
    sumCashAdded: 'Dépôts enveloppes',
    sumSpent: 'Somme des dépenses',
    ...
    addExpenseBtn: 'AJOUTER DÉPENSE / ARGENT',
    ...
    notesRemindersTitle: 'NOTES ET RAPPELS BUDGÉTAIRES',
    optionalLabel: '(optionnel)',
    notesRemindersDesc: 'Ajoutez des notes budgétaires personnalisées, des objectifs de paie ou des instructions. Les notes saisies apparaissent directement sur votre PDF exporté. Si laissé vide, votre PDF comportera des lignes vierges pour vos notes manuscrites.',
    notesRemindersPlaceholder: 'ex. Payer le loyer le 1er. Transférer 200 € sur l’épargne de secours le jour de la paie.',
    ...
    transactionTypeExpense: '💸 Dépense (Déduire de l’enveloppe)',
    transactionTypeAddCash: '💵 Ajouter de l’argent (Déposer)',
    ...
    bwTemplateDesc: 'Conçu en noir et blanc pour économiser l’encre.',
    ...
    pdfDocTitle: 'RELEVÉ BUDGÉTAIRE DES ENVELOPPES',
    pdfDocSubtitle: 'Rapport',
    pdfDateLabel: 'Généré le',
    pdfDateHeader: 'DATE',
    pdfPeriodLabel: 'Période Budgétaire',
    pdfAllocatedCard: 'TOTAL ALLOUÉ',
    pdfSpentCard: 'TOTAL DÉPENSÉ',
    pdfCashAddedCard: 'TOTAL ARGENT AJOUTÉ',
    pdfRemainingCard: 'TOTAL RESTANT',
    ...
    pdfCashAddedHeader: 'ARGENT AJOUTÉ',
    pdfRemainingHeader: 'SOLDE DISPONIBLE',
    pdfEnvelopeLedgers: 'REGISTRES DES ENVELOPPES',
    pdfEnvelopeLedgersSubtitle: 'Suivi chronologique par enveloppe avec solde progressif.',
    pdfTxSection: 'HISTORIQUE DES TRANSACTIONS',
    pdfDescHeader: 'NOTE / COMMERÇANT',
    pdfAmountHeader: 'MONTANT',
    pdfTypeHeader: 'TYPE',
    pdfRunningBalanceHeader: 'SOLDE PROGRESSIF',
    pdfTypeExpense: 'DÉPENSE',
    pdfTypeAddCash: 'ENTRÉE',
    pdfCategoryEnvelopeHeader: 'CATÉGORIE / ENVELOPPE',
    pdfTotalBalanceHeader: 'SOLDE TOTAL',
    pdfNotesSection: 'NOTES ET RAPPELS',
    pdfHandwritingText: 'Imprimez cette page pour écrire vos notes et rappels à la main.',
  ...
  de: {
    ...
    exchangeRateAccuracyNotice: 'Hinweis: Live-Wechselkurse dienen nur als Referenz und sind möglicherweise nicht zu 100 % genau oder in Echtzeit. Bitte prüfen Sie wichtige Kurse unabhängig.',
    ...
    logExpense: 'AUSGABE / BARGELD BUCHEN',
    import: 'Importieren',
    export: 'Exportieren',
    exportPdf: 'Als PDF Exportieren',
    exportExcel: 'Als Excel Exportieren',
    reset: 'Zurücksetzen',
    totalAllocated: 'Gesamt Budgetiert',
    totalCashAdded: 'Bargeld Hinzugefügt',
    totalSpent: 'Gesamt Ausgegeben',
    totalRemaining: 'Gesamt Verbleibend',
    labelAvailable: 'Verfügbar',
    labelSpent: 'Ausgegeben',
    labelCashAdded: 'Bargeld Hinzugefügt',
    sumAllocated: 'Summe der Umschlagziele',
    sumCashAdded: 'Einzahlungen Umschläge',
    sumSpent: 'Summe der Ausgaben',
    ...
    addExpenseBtn: 'AUSGABE / BARGELD HINZUFÜGEN',
    ...
    notesRemindersTitle: 'NOTIZEN UND ERINNERUNGEN',
    optionalLabel: '(optional)',
    notesRemindersDesc: 'Fügen Sie benutzerdefinierte Notizen, Zahltagsziele oder Anweisungen hinzu. Eingegebene Notizen erscheinen direkt auf Ihrem PDF. Wenn Sie dieses Feld leer lassen, enthält Ihr PDF leere Zeilen für handschriftliche Notizen.',
    notesRemindersPlaceholder: 'z.B. Miete am 1. bezahlen. 200 € am Zahltag auf das Notfallkonto überweisen.',
    ...
    logExpenseTitle: 'Ausgabe Buchen oder Bargeld Hinzufügen',
    editExpenseTitle: 'Transaktion Bearbeiten',
    selectEnvelopeLabel: 'Umschlag Auswählen',
    expenseAmountLabel: 'Betrag / Preis',
    expenseCurrencyLabel: 'Währung',
    vendorNoteLabel: 'Notiz / Händler (Optional)',
    vendorNotePlaceholder: 'z.B. Supermarkt, Gehalt, Rückzahlung',
    expenseDateLabel: 'Datum',
    transactionTypeLabel: 'Transaktionsart',
    transactionTypeExpense: '💸 Ausgabe (Vom Umschlag abziehen)',
    transactionTypeAddCash: '💵 Bargeld Hinzufügen (Einzahlung)',
    ...
    pdfDocTitle: 'UMSCHLAG-BUDGET-KASSENBUCH',
    pdfDocSubtitle: 'Bericht',
    pdfDateLabel: 'Erstellt am',
    pdfDateHeader: 'DATUM',
    pdfPeriodLabel: 'Budget-Zeitraum',
    pdfAllocatedCard: 'GESAMT ZUGEWIESEN',
    pdfSpentCard: 'GESAMT AUSGEGEBEN',
    pdfCashAddedCard: 'BARGELD HINZUGEFÜGT',
    pdfRemainingCard: 'GESAMT VERBLEIBEND',
    ...
    pdfCashAddedHeader: 'BARGELD HINZU',
    pdfRemainingHeader: 'RESTGUTHABEN',
    pdfEnvelopeLedgers: 'UMSCHLAG-KASSENBÜCHER',
    pdfEnvelopeLedgersSubtitle: 'Chronologisches Kassenbuch pro Umschlag mit laufendem Saldo.',
    pdfTxSection: 'TRANSAKTIONSHISTORIE',
    pdfDescHeader: 'NOTIZ / HÄNDLER',
    pdfAmountHeader: 'BETRAG',
    pdfTypeHeader: 'TYP',
    pdfRunningBalanceHeader: 'LAUFENDES SALDO',
    pdfTypeExpense: 'AUSGABE',
    pdfTypeAddCash: 'EINZAHLUNG',
    pdfCategoryEnvelopeHeader: 'KATEGORIE / UMSCHLAG',
    pdfTotalBalanceHeader: 'GESAMTSALDO',
    pdfNotesSection: 'NOTIZEN UND ERINNERUNGEN',
    pdfHandwritingText: 'Drucken Sie diese Seite aus, um Notizen und Erinnerungen handschriftlich einzutragen.',
