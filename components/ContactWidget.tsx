          ...
          <div className="bg-[#FCFAF7] border-4 border-[#141414] shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] p-5 space-y-4 relative">
            ...
            {isSubmitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                ...
                {/* Submit Button */}
                <div className="flex items-center justify-between pt-2 border-t-2 border-[#141414]">
                  <a
                    href={GOOGLE_FORM_VIEW_URL}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[10px] font-bold uppercase text-[#5C768D] hover:underline flex items-center gap-1"
                  >
